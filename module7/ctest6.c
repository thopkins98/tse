 ...
 * Created: Tue Nov 17 02:46:15 2020 (-0500)
 * Version: 
 * 
 * Description: 
 * 
...
int main(void) {
	...
	printf("Deleting item 'First_Process' in hashtable\n");

	concurrent_t *res1= (concurrent_t*) lhremove(lht, search, "First_process", strlen("First_process"));
  ...
  //printf("The item found is: %s, with id: %d\n", res2->key, res2->id); 
	printf("Items that exist in the hashtable now: \n");
	lhapply(lht, print);
	lhclose(lht);
